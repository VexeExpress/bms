...
const ModalTrip = ({
    ...
    const [timeDepartureError, setTimeDepartureError] = useState<string | null>(null);
    const [seatChartError, setSeatingChartError] = useState<string | null>(null);
    const [dateDepartureError, setDateDepartureError] = useState<string | null>(null);
    ...
    useEffect(() => {
        ...
        if (selectedDate) {
            setDateDeparture(selectedDate.toString().split("T")[0]);
            console.log("Ngày khởi hành:", selectedDate);
            console.log("Ngày khởi hành:", dateDeparture);
                    ...
                    <div className="mb-10 mt-5">
                        <Grid container spacing={3}>
                            ...
                            <Grid item xs={12} sm={6} md={3}>
                                ...
                                {dateDepartureError && (
                                    <div className="text-red-500 text-xs mt-1 font-rounded">
                                        {dateDepartureError}
                                    </div>
