...
export const setStorage_EmployeeId = (employeeId: string) => {
    Cookies.set("employeeId", employeeId, { expires: 1, secure: true, sameSite: "Strict" });
};

export const setStorage_FullName = (fullName: string) => {
    Cookies.set("fullName", fullName, { expires: 1, secure: true, sameSite: "Strict" });
};

export const setStorage_CompanyId = (companyId: string) => {
    Cookies.set("companyId", companyId, { expires: 1, secure: true, sameSite: "Strict" });
};

export const setStorage_CompanyName = (companyName: string) => {
    Cookies.set("companyName", companyName, { expires: 1, secure: true, sameSite: "Strict" });
};
